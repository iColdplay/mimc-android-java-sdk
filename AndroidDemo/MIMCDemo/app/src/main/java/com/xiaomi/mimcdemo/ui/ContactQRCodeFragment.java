...
public class ContactQRCodeFragment extends BaseDialogFragment {

    public static final String TAG = ContactQRCodeFragment.class.getSimpleName();
    ...
    public static ContactQRCodeFragment newInstance() {
        ContactQRCodeFragment dialog = new ContactQRCodeFragment();
        return dialog;
    }
